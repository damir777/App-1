...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
            <h2 class="page-title">{{ trans('main.new_wage') }}</h2>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    {{ Form::open(array('route' => 'InsertWage', 'autocomplete' => 'off')) }}
                    <div class="row">
                        <div class="col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group @if ($errors->has('country')) has-error @endif">
                                            ...
                                            {{ Form::select('country', $countries, 'HR', array('class' => 'form-control')) }}
                    ...
                    <div class="row m-t">
                        <div class="col-sm-12">
                            <div class="text-center">
                                <a href="{{ route('GetWages') }}" class="btn btn-warning">
