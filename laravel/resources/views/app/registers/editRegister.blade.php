...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
            <h2 class="page-title">{{ trans('main.edit_register') }}</h2>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    {{ Form::open(array('route' => 'UpdateRegister', 'autocomplete' => 'off')) }}
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group @if ($errors->has('label')) has-error @endif">
                                            ...
                                            {{ Form::text('label', $register->label, array('class' => 'form-control',
                                                'required')) }}
                                            @if ($errors->has('label'))
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group @if ($errors->has('office')) has-error @endif">
                                            ...
                                            {{ Form::select('office', $offices, $register->office_id,
