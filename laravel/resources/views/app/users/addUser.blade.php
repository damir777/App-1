...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
            <h2 class="page-title">{{ trans('main.new_user') }}</h2>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    {{ Form::open(array('route' => 'InsertUser', 'autocomplete' => 'off')) }}
                    <div class="row">
                        <div class="col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group @if ($errors->has('register')) has-error @endif">
                                            ...
                                            {{ Form::select('register', $registers, null, array('class' => 'form-control',
                                                'required')) }}
