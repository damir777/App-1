...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
            <h2 class="page-title">{{ trans('main.edit_employee') }}</h2>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    {{ Form::open(array('route' => 'UpdateEmployee', 'autocomplete' => 'off')) }}
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group @if ($errors->has('job_title')) has-error @endif">
                                            ...
                                            {{ Form::text('job_title', $employee->job_title, array('class' => 'form-control',
                                                'required')) }}
