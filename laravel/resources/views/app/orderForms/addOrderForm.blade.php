...
@section('content')
    <div class="page-heading-wrapper" data-spy="affix" data-offset-top="60">
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-xs-8">
                <h2 class="page-title">{{ trans('main.new_order_form') }}</h2>
            </div>
            <div class="col-xs-4">
                ...
                <div class="row">
                    <div class="col-sm-12">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            {{ Form::text('delivery_date', null, array('class' => 'form-control delivery-date')) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div id="order-form-products" style="display: none">
